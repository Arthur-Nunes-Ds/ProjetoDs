...
import { useNavigation } from '@react-navigation/native'; // Assumindo que você usa React Navigation
    ...
    <LinearGradient colors={['#1A2980', '#26D0CE']} style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          {/* Card Principal do Form (Glassmorphism) */}
...
const styles = StyleSheet.create({
  ...
  card: {
    backgroundColor: 'rgba(25, 30, 50, 0.6)', // Glassmorphism escuro
    borderRadius: 24,
    padding: 24,
    borderWidth: 1,
  ...
  // Controles Inferiores (Stepper Nav)
  stepperControls: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    marginTop: 20,
