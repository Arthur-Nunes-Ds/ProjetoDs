...
import FlowingMenu from '/src/styles/FlowingMenu';
    ...
    <footer className="border-t border-white/10 bg-black/80 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-10 py-10">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10">
          ...
          <div className="space-y-4 max-w-sm">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Plataforma inteligente para monitorar, analisar e reduzir o consumo
          ...
          <nav className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm">
            <div className="space-y-3">
              <h4 className="text-white/70 uppercase tracking-wider">
                Produto
              </h4>
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#personalizados" className="hover:text-white">Personalizados</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#objetivos" className="hover:text-white">Objetivos</a></li>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <a
                    href="https://github.com/NunesDevelloper/ProjetoDs"
                    target="_blank"
                    rel="noreferrer"
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          <span>
            © {new Date().getFullYear()} Consumo Sustentável. Todos os direitos reservados.
          </span>
